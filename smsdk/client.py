...
class Client(object):
    ...
    def get_cycles_v1(self, normalize=True, clean_strings_in=True, clean_strings_out=True, *args, **kwargs):
        """
        Retrieve cycle/machine data.
        ...
        df = self.get_data_v1('cycle', 'get_cycles', normalize, *args, **kwargs)
