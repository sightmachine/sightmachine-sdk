ALERT_PAYLOAD = {
    ...
    "trigger": {
        ...
        "schedule": {"interval": {"every": 10, "period": "days"}},
    },
    "analytic": {
        ...
        "plugin_parameters": {
            ...
            "analytics": {},
            "alert_config": {
                "max_latency": {"every": 1, "period": "days"},
                "black_list": [],
                "white_list": [
    ...
    "notification": {
        "backend": {
            "email": {
                "silence_window": {"every": 1, "period": "days"},
                "email_list": [
                    {"to_email": "cjadhav@sightmachine.com", "name": "chaitanya jadhav"}
                ],
