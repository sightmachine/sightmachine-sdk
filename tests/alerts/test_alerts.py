...
def test_get_alert_config(mock_get_alert_config: MagicMock, get_session: Any) -> None:
    ...
    alerts_instance = Alerts(
        get_session, TENANT or "genmills-ms-rbg"
    )  # Create an instance
...
def test_update_alert_group(
    mock_update_alert_group: MagicMock, get_session: Any
) -> None:
...
def test_get_alert_dataframe(
    mock_get_alert_dataframe: MagicMock, get_session: Any
) -> None:
    mock_df = MagicMock()
